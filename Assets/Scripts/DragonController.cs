...
public class DragonController : AgentController
{
    public static readonly string LogTag = typeof(DragonController).Name;
    ...
    public DieDelegate OnDieDelegate = () => {};
    ...
    void Update()
    {
        ...
        } else if (playerDist < scanRange && player.IsAlive && !player.IsTalking) {
            _isWandering = false;
